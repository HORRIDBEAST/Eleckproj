...
module tb_FIFO;
    ...
    wire [7:0] counter; // Number of elements in FIFO
    ...
    // Monitor signals
    initial begin
        $monitor("Time=%0t | clk=%b | rst=%b | wr_en=%b | rd_en=%b | buf_in=%d | buf_out=%d | buf_empty=%b | buf_full=%b | counter=%d",
                 $time, clk, rst, wr_en, rd_en, buf_in, buf_out, buf_empty, buf_full, counter);
    end
