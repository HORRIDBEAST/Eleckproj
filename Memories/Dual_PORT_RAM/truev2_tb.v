...
module tb_true_ram_dual_port2;
  ...
  initial begin
    ...
    for (i = 0; i < 5; i = i + 1) begin
      ...
      data_a = i + 50;
      #2;  // Small delay
      $display("Port A -> Addr: %2d, Data Written: %3d, Old Data Read: %3d", add_a, data_a, q_a);
    end
    we_a = 0;
    ...
    for (i = 5; i < 10; i = i + 1) begin
      ...
      data_b = i + 100;
      #2;
      $display("Port B -> Addr: %2d, Data Written: %3d, Old Data Read: %3d", add_b, data_b, q_b);
    end
    we_b = 0;
